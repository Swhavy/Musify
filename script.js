...
let jamz = ["musics/01 - Whatcha Say - (Musicfire.in) - Copy - Copy.mp3", "musics/01 chandelier_sia.mp3", "musics/01 Never Go Down (feat_ Limoblaze).mp3", "musics/03 Trap (feat. Lil Baby).mp3", "musics/04 Grace.mp3", "musics/05 Woah_1.mp3", "musics/07 I HATE EVERYBODY - (SongsLover.com).mp3"]
